...
export type ScrapingDomError<E extends ScrapingDomErrorCode = ScrapingDomErrorCode> = {
  [ScrapingErrorCode.INVALID_ATTRIBUTE]: InvalidAttributeError;
  [ScrapingErrorCode.MISSING_ATTRIBUTE]: MissingAttributeError;
  [ScrapingErrorCode.MISSING_TEXT]: MissingTextError;
  [ScrapingErrorCode.MISSING_ELEMENT]: MissingElementError;
  [ScrapingErrorCode.NONUNIQUE_ELEMENT]: NonUniqueElementError;
  [ScrapingErrorCode.NONUNIQUE_TEXT]: NonUniqueTextError;
  [ScrapingErrorCode.INVALID_TEXT]: InvalidTextError;
}[E];

export const isScrapingDomError = (e: unknown): e is ScrapingDomError =>
  isError(e) &&
  [
