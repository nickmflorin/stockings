...
type SchemaType = z.ZodType<Prisma.NotificationEventConfigUncheckedUpdateManyInput>;
export const NotificationEventConfigUncheckedUpdateManyInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
