...
type SchemaType = z.ZodType<Prisma.PriceChangeEventConfigUncheckedUpdateWithoutCreatedByInput>;
export const PriceChangeEventConfigUncheckedUpdateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
