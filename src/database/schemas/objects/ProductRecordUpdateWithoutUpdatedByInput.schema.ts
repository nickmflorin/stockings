...
type SchemaType = z.ZodType<Prisma.ProductRecordUpdateWithoutUpdatedByInput>;
export const ProductRecordUpdateWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => ProductRecordDataFieldSchema).array()]).optional(), createdBy: z.lazy(() => UserUpdateOneRequiredWithoutCreatedProductRecordsNestedInputObjectSchema).optional(), product: z.lazy(() => ProductUpdateOneRequiredWithoutRecordsNestedInputObjectSchema).optional(), errors: z.lazy(() => ProductRecordErrorUpdateManyWithoutRecordNestedInputObjectSchema).optional()
