...
type SchemaType = z.ZodType<Prisma.HttpClientErrorDataUncheckedUpdateManyInput>;
export const HttpClientErrorDataUncheckedUpdateManyInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
