...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutUpdatedProductRecordsInput>;
export const UserUpdateWithoutUpdatedProductRecordsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
