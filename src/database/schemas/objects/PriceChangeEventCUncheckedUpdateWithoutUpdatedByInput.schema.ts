...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCUncheckedUpdateWithoutUpdatedByInput>;
export const PriceChangeEventCUncheckedUpdateWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
