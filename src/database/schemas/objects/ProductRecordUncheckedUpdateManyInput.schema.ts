...
type SchemaType = z.ZodType<Prisma.ProductRecordUncheckedUpdateManyInput>;
export const ProductRecordUncheckedUpdateManyInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
