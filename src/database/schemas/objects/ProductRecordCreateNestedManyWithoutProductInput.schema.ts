...
type SchemaType = z.ZodType<Prisma.ProductRecordCreateNestedManyWithoutProductInput>;
export const ProductRecordCreateNestedManyWithoutProductInputObjectSchema: SchemaType = z.object({
