...
type SchemaType = z.ZodType<Prisma.StatusChangeEventCountAggregateInputType>;
export const StatusChangeEventCountAggregateInputObjectSchema: SchemaType = z.object({
