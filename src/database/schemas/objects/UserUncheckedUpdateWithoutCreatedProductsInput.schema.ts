...
type SchemaType = z.ZodType<Prisma.UserUncheckedUpdateWithoutCreatedProductsInput>;
export const UserUncheckedUpdateWithoutCreatedProductsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
