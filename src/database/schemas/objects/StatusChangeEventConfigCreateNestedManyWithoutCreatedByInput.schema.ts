...
type SchemaType = z.ZodType<Prisma.StatusChangeEventConfigCreateNestedManyWithoutCreatedByInput>;
export const StatusChangeEventConfigCreateNestedManyWithoutCreatedByInputObjectSchema: SchemaType = z.object({
