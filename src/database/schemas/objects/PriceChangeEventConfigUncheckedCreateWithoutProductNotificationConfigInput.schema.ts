...
type SchemaType = z.ZodType<Prisma.PriceChangeEventConfigUncheckedCreateWithoutProductNotificationConfigInput>;
export const PriceChangeEventConfigUncheckedCreateWithoutProductNotificationConfigInputObjectSchema: SchemaType = z.object({
    id: z.string().optional(), createdAt: z.union([z.date().optional(), z.string().datetime().optional()]), createdById: z.string(), updatedAt: z.union([z.date().optional(), z.string().datetime().optional()]), updatedById: z.string(), contentType: z.lazy(() => NotificationEventConfigContentTypeSchema), eventTypes: z.union([z.lazy(() => PriceChangeEventConfigCreateeventTypesInputObjectSchema),
