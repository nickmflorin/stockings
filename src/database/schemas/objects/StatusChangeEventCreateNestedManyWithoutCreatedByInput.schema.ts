...
type SchemaType = z.ZodType<Prisma.StatusChangeEventCreateNestedManyWithoutCreatedByInput>;
export const StatusChangeEventCreateNestedManyWithoutCreatedByInputObjectSchema: SchemaType = z.object({
