...
type SchemaType = z.ZodType<Prisma.ProductUncheckedCreateWithoutCreatedByInput>;
export const ProductUncheckedCreateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.string().optional(), createdAt: z.union([z.date().optional(), z.string().datetime().optional()]), updatedAt: z.union([z.date().optional(), z.string().datetime().optional()]), updatedById: z.string(), name: z.union([z.string(),
