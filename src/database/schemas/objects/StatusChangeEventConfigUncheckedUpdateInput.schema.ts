...
type SchemaType = z.ZodType<Prisma.StatusChangeEventConfigUncheckedUpdateInput>;
export const StatusChangeEventConfigUncheckedUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
