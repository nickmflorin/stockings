...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUncheckedUpdateInput>;
export const StatusChangeEventUncheckedUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
