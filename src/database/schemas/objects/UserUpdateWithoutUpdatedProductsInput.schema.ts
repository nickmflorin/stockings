...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutUpdatedProductsInput>;
export const UserUpdateWithoutUpdatedProductsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
