...
type SchemaType = z.ZodType<Prisma.NotificationEventUncheckedUpdateWithoutUserInput>;
export const NotificationEventUncheckedUpdateWithoutUserInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
