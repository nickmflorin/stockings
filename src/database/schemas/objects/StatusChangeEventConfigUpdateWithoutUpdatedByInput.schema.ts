...
type SchemaType = z.ZodType<Prisma.StatusChangeEventConfigUpdateWithoutUpdatedByInput>;
export const StatusChangeEventConfigUpdateWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
