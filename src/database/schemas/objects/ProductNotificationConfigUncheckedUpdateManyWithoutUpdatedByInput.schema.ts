...
type SchemaType = z.ZodType<Prisma.ProductNotificationConfigUncheckedUpdateManyWithoutUpdatedByInput>;
export const ProductNotificationConfigUncheckedUpdateManyWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
