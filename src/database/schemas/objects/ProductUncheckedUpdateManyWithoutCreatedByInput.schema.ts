...
type SchemaType = z.ZodType<Prisma.ProductUncheckedUpdateManyWithoutCreatedByInput>;
export const ProductUncheckedUpdateManyWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
