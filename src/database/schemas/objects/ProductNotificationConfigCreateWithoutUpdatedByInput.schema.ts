...
type SchemaType = z.ZodType<Prisma.ProductNotificationConfigCreateWithoutUpdatedByInput>;
export const ProductNotificationConfigCreateWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
