...
type SchemaType = z.ZodType<Prisma.NotificationEventUncheckedUpdateWithoutProductInput>;
export const NotificationEventUncheckedUpdateWithoutProductInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
