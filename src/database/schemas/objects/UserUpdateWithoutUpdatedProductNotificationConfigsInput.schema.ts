...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutUpdatedProductNotificationConfigsInput>;
export const UserUpdateWithoutUpdatedProductNotificationConfigsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
