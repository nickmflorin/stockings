...
type SchemaType = z.ZodType<Prisma.ProductCreateNestedManyWithoutCreatedByInput>;
export const ProductCreateNestedManyWithoutCreatedByInputObjectSchema: SchemaType = z.object({
