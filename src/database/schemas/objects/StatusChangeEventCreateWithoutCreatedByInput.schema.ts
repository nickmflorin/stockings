...
type SchemaType = z.ZodType<Prisma.StatusChangeEventCreateWithoutCreatedByInput>;
export const StatusChangeEventCreateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
