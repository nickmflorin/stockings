...
type SchemaType = z.ZodType<Prisma.ProductRecordUncheckedUpdateWithoutCreatedByInput>;
export const ProductRecordUncheckedUpdateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
