...
type SchemaType = z.ZodType<Prisma.ProductRecordErrorWhereInput>;
export const ProductRecordErrorWhereInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => ProductRecordErrorWhereInputObjectSchema),
    ...
    z.lazy(() => ProductRecordErrorWhereInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => UuidFilterObjectSchema),
