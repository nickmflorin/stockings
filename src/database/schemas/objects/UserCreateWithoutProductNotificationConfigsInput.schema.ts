...
type SchemaType = z.ZodType<Prisma.UserCreateWithoutProductNotificationConfigsInput>;
export const UserCreateWithoutProductNotificationConfigsInputObjectSchema: SchemaType = z.object({
