...
type SchemaType = z.ZodType<Prisma.ProductRecordErrorMaxOrderByAggregateInput>;
export const ProductRecordErrorMaxOrderByAggregateInputObjectSchema: SchemaType = z.object({
