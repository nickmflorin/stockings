...
type SchemaType = z.ZodType<Prisma.InvalidAttributeErrorDataUncheckedUpdateInput>;
export const InvalidAttributeErrorDataUncheckedUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
