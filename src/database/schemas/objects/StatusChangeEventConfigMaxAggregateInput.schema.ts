...
type SchemaType = z.ZodType<Prisma.StatusChangeEventConfigMaxAggregateInputType>;
export const StatusChangeEventConfigMaxAggregateInputObjectSchema: SchemaType = z.object({
