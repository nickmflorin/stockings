...
type SchemaType = z.ZodType<Prisma.StatusChangeEventConfigUncheckedUpdateWithoutCreatedByInput>;
export const StatusChangeEventConfigUncheckedUpdateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
