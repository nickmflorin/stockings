...
type SchemaType = z.ZodType<Prisma.NotificationEventUncheckedUpdateWithoutUpdatedByInput>;
export const NotificationEventUncheckedUpdateWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
