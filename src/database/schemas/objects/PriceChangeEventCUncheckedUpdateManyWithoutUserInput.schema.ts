...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCUncheckedUpdateManyWithoutUserInput>;
export const PriceChangeEventCUncheckedUpdateManyWithoutUserInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
