...
type SchemaType = z.ZodType<Prisma.StatusChangeEventCreateNestedManyWithoutProductInput>;
export const StatusChangeEventCreateNestedManyWithoutProductInputObjectSchema: SchemaType = z.object({
