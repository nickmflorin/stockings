...
type SchemaType = z.ZodType<Prisma.ProductNotificationConfigCreateInput>;
export const ProductNotificationConfigCreateInputObjectSchema: SchemaType = z.object({
