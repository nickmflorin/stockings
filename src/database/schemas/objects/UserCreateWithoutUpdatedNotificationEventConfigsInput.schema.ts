...
type SchemaType = z.ZodType<Prisma.UserCreateWithoutUpdatedNotificationEventConfigsInput>;
export const UserCreateWithoutUpdatedNotificationEventConfigsInputObjectSchema: SchemaType = z.object({
