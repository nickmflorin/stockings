...
type SchemaType = z.ZodType<Prisma.NotificationEventUncheckedUpdateManyWithoutUserInput>;
export const NotificationEventUncheckedUpdateManyWithoutUserInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
