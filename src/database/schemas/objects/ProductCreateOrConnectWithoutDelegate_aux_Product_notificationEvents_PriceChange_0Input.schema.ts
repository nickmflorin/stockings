...
type SchemaType = z.ZodType<Prisma.ProductCreateOrConnectWithoutDelegate_aux_Product_notificationEvents_PriceChange_0Input>;
export const ProductCreateOrConnectWithoutDelegate_aux_Product_notificationEvents_PriceChange_0InputObjectSchema: SchemaType = z.object({
    where: z.lazy(() => ProductWhereUniqueInputObjectSchema), create: z.union([z.lazy(() => ProductCreateWithoutDelegate_aux_Product_notificationEvents_PriceChange_0InputObjectSchema),
