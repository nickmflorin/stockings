...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUncheckedUpdateWithoutProductInput>;
export const StatusChangeEventUncheckedUpdateWithoutProductInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
