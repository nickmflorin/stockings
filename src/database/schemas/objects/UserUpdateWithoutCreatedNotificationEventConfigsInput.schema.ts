...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutCreatedNotificationEventConfigsInput>;
export const UserUpdateWithoutCreatedNotificationEventConfigsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
