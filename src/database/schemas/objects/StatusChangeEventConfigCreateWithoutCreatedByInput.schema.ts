...
type SchemaType = z.ZodType<Prisma.StatusChangeEventConfigCreateWithoutCreatedByInput>;
export const StatusChangeEventConfigCreateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => ProductStatusSchema).array()]).optional(), updatedBy: z.lazy(() => UserCreateNestedOneWithoutDelegate_aux_User_updatedNotificationEventConfigs_S_0InputObjectSchema), productNotificationConfig: z.lazy(() => ProductNotificationConfigCreateNestedOneWithoutDelegate_aux_ProductNotificationConfig_eventConfigs_1InputObjectSchema)
