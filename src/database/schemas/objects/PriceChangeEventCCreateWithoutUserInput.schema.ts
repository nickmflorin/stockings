...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCCreateWithoutUserInput>;
export const PriceChangeEventCCreateWithoutUserInputObjectSchema: SchemaType = z.object({
