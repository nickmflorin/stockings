...
type SchemaType = z.ZodType<Prisma.UserUncheckedUpdateWithoutUpdatedProductsInput>;
export const UserUncheckedUpdateWithoutUpdatedProductsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
