...
type SchemaType = z.ZodType<Prisma.MissingElementErrorDataUncheckedUpdateInput>;
export const MissingElementErrorDataUncheckedUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
