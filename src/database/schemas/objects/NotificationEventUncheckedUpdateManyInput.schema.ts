...
type SchemaType = z.ZodType<Prisma.NotificationEventUncheckedUpdateManyInput>;
export const NotificationEventUncheckedUpdateManyInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
