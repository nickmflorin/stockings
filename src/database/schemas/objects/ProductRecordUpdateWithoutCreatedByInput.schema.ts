...
import { ProductRecordErrorUpdateManyWithoutRecordNestedInputObjectSchema } from './ProductRecordErrorUpdateManyWithoutRecordNestedInput.schema';

import type { Prisma } from '../../../../generated/models';

type SchemaType = z.ZodType<Prisma.ProductRecordUpdateWithoutCreatedByInput>;
export const ProductRecordUpdateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => ProductRecordDataFieldSchema).array()]).optional(), updatedBy: z.lazy(() => UserUpdateOneRequiredWithoutUpdatedProductRecordsNestedInputObjectSchema).optional(), product: z.lazy(() => ProductUpdateOneRequiredWithoutRecordsNestedInputObjectSchema).optional(), errors: z.lazy(() => ProductRecordErrorUpdateManyWithoutRecordNestedInputObjectSchema).optional()
