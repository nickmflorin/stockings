...
type SchemaType = z.ZodType<Prisma.NotificationEventConfigUncheckedCreateWithoutUpdatedByInput>;
export const NotificationEventConfigUncheckedCreateWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
