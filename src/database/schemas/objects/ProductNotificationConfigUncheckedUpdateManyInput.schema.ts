...
type SchemaType = z.ZodType<Prisma.ProductNotificationConfigUncheckedUpdateManyInput>;
export const ProductNotificationConfigUncheckedUpdateManyInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
