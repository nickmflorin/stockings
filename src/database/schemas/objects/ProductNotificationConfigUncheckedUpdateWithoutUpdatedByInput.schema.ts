...
type SchemaType = z.ZodType<Prisma.ProductNotificationConfigUncheckedUpdateWithoutUpdatedByInput>;
export const ProductNotificationConfigUncheckedUpdateWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
