...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutDelegate_aux_User_updatedNotificationEvents_PriceCh_0Input>;
export const UserUpdateWithoutDelegate_aux_User_updatedNotificationEvents_PriceCh_0InputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
