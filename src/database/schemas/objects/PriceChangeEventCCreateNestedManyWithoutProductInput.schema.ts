...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCCreateNestedManyWithoutProductInput>;
export const PriceChangeEventCCreateNestedManyWithoutProductInputObjectSchema: SchemaType = z.object({
