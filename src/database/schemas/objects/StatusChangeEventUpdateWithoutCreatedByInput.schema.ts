...
import { UserUpdateOneRequiredWithoutDelegate_aux_User_notificationEvents_StatusChangeEv_0NestedInputObjectSchema } from './UserUpdateOneRequiredWithoutDelegate_aux_User_notificationEvents_StatusChangeEv_0NestedInput.schema';

import type { Prisma } from '../../../../generated/models';

type SchemaType = z.ZodType<Prisma.StatusChangeEventUpdateWithoutCreatedByInput>;
export const StatusChangeEventUpdateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => ProductStatusSchema).array()]).optional(), updatedBy: z.lazy(() => UserUpdateOneRequiredWithoutDelegate_aux_User_updatedNotificationEvents_StatusC_0NestedInputObjectSchema).optional(), product: z.lazy(() => ProductUpdateOneRequiredWithoutDelegate_aux_Product_notificationEvents_StatusChang_0NestedInputObjectSchema).optional(), user: z.lazy(() => UserUpdateOneRequiredWithoutDelegate_aux_User_notificationEvents_StatusChangeEv_0NestedInputObjectSchema).optional()
