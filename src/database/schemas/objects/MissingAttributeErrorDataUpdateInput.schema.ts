...
type SchemaType = z.ZodType<Prisma.MissingAttributeErrorDataUpdateInput>;
export const MissingAttributeErrorDataUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
