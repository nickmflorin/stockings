...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutDelegate_aux_User_notificationEvents_StatusChangeEv_0Input>;
export const UserUpdateWithoutDelegate_aux_User_notificationEvents_StatusChangeEv_0InputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
