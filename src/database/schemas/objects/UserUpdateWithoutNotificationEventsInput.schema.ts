...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutNotificationEventsInput>;
export const UserUpdateWithoutNotificationEventsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
