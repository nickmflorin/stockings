...
import { NotificationEventUpdateManyWithoutUpdatedByNestedInputObjectSchema } from './NotificationEventUpdateManyWithoutUpdatedByNestedInput.schema';
...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutDelegate_aux_User_updatedNotificationEvents_StatusC_0Input>;
export const UserUpdateWithoutDelegate_aux_User_updatedNotificationEvents_StatusC_0InputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => DateTimeFieldUpdateOperationsInputObjectSchema)]).optional(), createdProducts: z.lazy(() => ProductUpdateManyWithoutCreatedByNestedInputObjectSchema).optional(), updatedProducts: z.lazy(() => ProductUpdateManyWithoutUpdatedByNestedInputObjectSchema).optional(), createdProductRecords: z.lazy(() => ProductRecordUpdateManyWithoutCreatedByNestedInputObjectSchema).optional(), updatedProductRecords: z.lazy(() => ProductRecordUpdateManyWithoutUpdatedByNestedInputObjectSchema).optional(), createdNotificationEvents: z.lazy(() => NotificationEventUpdateManyWithoutCreatedByNestedInputObjectSchema).optional(), updatedNotificationEvents: z.lazy(() => NotificationEventUpdateManyWithoutUpdatedByNestedInputObjectSchema).optional(), notificationEvents: z.lazy(() => NotificationEventUpdateManyWithoutUserNestedInputObjectSchema).optional(), delegate_aux_User_createdNotificationEvents_PriceCh_0: z.lazy(() => PriceChangeEventCUpdateManyWithoutCreatedByNestedInputObjectSchema).optional(), delegate_aux_User_createdNotificationEvents_StatusC_0: z.lazy(() => StatusChangeEventUpdateManyWithoutCreatedByNestedInputObjectSchema).optional(), delegate_aux_User_updatedNotificationEvents_PriceCh_0: z.lazy(() => PriceChangeEventCUpdateManyWithoutUpdatedByNestedInputObjectSchema).optional(), delegate_aux_User_notificationEvents_PriceChangeEve_0: z.lazy(() => PriceChangeEventCUpdateManyWithoutUserNestedInputObjectSchema).optional(), delegate_aux_User_notificationEvents_StatusChangeEv_0: z.lazy(() => StatusChangeEventUpdateManyWithoutUserNestedInputObjectSchema).optional()
