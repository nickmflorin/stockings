...
type SchemaType = z.ZodType<Prisma.NotificationEventUncheckedCreateNestedManyWithoutUpdatedByInput>;
export const NotificationEventUncheckedCreateNestedManyWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
