...
type SchemaType = z.ZodType<Prisma.UserUncheckedUpdateWithoutUpdatedNotificationEventsInput>;
export const UserUncheckedUpdateWithoutUpdatedNotificationEventsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
