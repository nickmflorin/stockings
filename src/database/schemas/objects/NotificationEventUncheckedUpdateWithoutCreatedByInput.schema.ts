...
type SchemaType = z.ZodType<Prisma.NotificationEventUncheckedUpdateWithoutCreatedByInput>;
export const NotificationEventUncheckedUpdateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
