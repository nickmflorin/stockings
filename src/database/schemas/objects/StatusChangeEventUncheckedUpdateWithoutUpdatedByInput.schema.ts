...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUncheckedUpdateWithoutUpdatedByInput>;
export const StatusChangeEventUncheckedUpdateWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
