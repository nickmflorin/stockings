...
type SchemaType = z.ZodType<Prisma.MissingElementErrorDataUncheckedUpdateManyInput>;
export const MissingElementErrorDataUncheckedUpdateManyInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
