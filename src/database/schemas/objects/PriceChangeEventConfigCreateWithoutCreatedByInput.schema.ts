...
type SchemaType = z.ZodType<Prisma.PriceChangeEventConfigCreateWithoutCreatedByInput>;
export const PriceChangeEventConfigCreateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
