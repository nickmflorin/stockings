...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCUncheckedUpdateWithoutUserInput>;
export const PriceChangeEventCUncheckedUpdateWithoutUserInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
