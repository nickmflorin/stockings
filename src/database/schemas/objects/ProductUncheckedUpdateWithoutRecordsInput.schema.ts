...
export const ProductUncheckedUpdateWithoutRecordsInputObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => ProductSubCategorySchema).array()]).optional(), notificationConfigs: z.lazy(() => ProductNotificationConfigUncheckedUpdateManyWithoutProductNestedInputObjectSchema).optional()
