...
import { PriceChangeEventCUncheckedCreateNestedManyWithoutUpdatedByInputObjectSchema } from './PriceChangeEventCUncheckedCreateNestedManyWithoutUpdatedByInput.schema';
