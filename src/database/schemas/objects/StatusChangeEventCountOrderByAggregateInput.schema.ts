...
type SchemaType = z.ZodType<Prisma.StatusChangeEventCountOrderByAggregateInput>;
export const StatusChangeEventCountOrderByAggregateInputObjectSchema: SchemaType = z.object({
