...
type SchemaType = z.ZodType<Prisma.NotificationEventUncheckedUpdateInput>;
export const NotificationEventUncheckedUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
