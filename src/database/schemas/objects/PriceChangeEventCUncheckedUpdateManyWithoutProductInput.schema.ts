...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCUncheckedUpdateManyWithoutProductInput>;
export const PriceChangeEventCUncheckedUpdateManyWithoutProductInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
