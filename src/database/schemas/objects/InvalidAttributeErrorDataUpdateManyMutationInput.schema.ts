...
type SchemaType = z.ZodType<Prisma.InvalidAttributeErrorDataUpdateManyMutationInput>;
export const InvalidAttributeErrorDataUpdateManyMutationInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
