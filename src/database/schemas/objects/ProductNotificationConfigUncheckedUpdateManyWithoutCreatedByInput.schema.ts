...
type SchemaType = z.ZodType<Prisma.ProductNotificationConfigUncheckedUpdateManyWithoutCreatedByInput>;
export const ProductNotificationConfigUncheckedUpdateManyWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
