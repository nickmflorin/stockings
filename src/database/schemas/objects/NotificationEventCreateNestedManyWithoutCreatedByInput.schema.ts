...
type SchemaType = z.ZodType<Prisma.NotificationEventCreateNestedManyWithoutCreatedByInput>;
export const NotificationEventCreateNestedManyWithoutCreatedByInputObjectSchema: SchemaType = z.object({
