...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUncheckedUpdateWithoutUserInput>;
export const StatusChangeEventUncheckedUpdateWithoutUserInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
