...
type SchemaType = z.ZodType<Prisma.ProductUncheckedCreateWithoutDelegate_aux_Product_notificationEvents_PriceChange_0Input>;
export const ProductUncheckedCreateWithoutDelegate_aux_Product_notificationEvents_PriceChange_0InputObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => ProductSubCategorySchema).array()]).optional(), records: z.lazy(() => ProductRecordUncheckedCreateNestedManyWithoutProductInputObjectSchema).optional(), notificationEvents: z.lazy(() => NotificationEventUncheckedCreateNestedManyWithoutProductInputObjectSchema).optional(), delegate_aux_Product_notificationEvents_StatusChang_0: z.lazy(() => StatusChangeEventUncheckedCreateNestedManyWithoutProductInputObjectSchema).optional()
