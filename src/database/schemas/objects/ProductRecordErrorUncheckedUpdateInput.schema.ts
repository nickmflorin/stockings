...
type SchemaType = z.ZodType<Prisma.ProductRecordErrorUncheckedUpdateInput>;
export const ProductRecordErrorUncheckedUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
