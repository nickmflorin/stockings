...
type SchemaType = z.ZodType<Prisma.ProductRecordErrorUpdateManyMutationInput>;
export const ProductRecordErrorUpdateManyMutationInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
