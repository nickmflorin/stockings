...
export const ProductNotificationConfigWhereInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => ProductNotificationConfigWhereInputObjectSchema),
    ...
    z.lazy(() => ProductNotificationConfigWhereInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => UuidFilterObjectSchema),
