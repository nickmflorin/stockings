...
type SchemaType = z.ZodType<Prisma.UserUncheckedUpdateWithoutProductNotificationConfigsInput>;
export const UserUncheckedUpdateWithoutProductNotificationConfigsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
