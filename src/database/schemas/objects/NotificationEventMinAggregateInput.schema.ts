...
type SchemaType = z.ZodType<Prisma.NotificationEventMinAggregateInputType>;
export const NotificationEventMinAggregateInputObjectSchema: SchemaType = z.object({
