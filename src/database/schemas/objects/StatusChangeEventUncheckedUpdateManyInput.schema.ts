...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUncheckedUpdateManyInput>;
export const StatusChangeEventUncheckedUpdateManyInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
