...
type SchemaType = z.ZodType<Prisma.ProductRecordErrorUncheckedUpdateManyInput>;
export const ProductRecordErrorUncheckedUpdateManyInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => EnumScrapingErrorCodeFieldUpdateOperationsInputObjectSchema)]).optional(), recordId: z.union([z.string(),
    z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(), field: z.union([z.lazy(() => ProductRecordDataFieldSchema),
