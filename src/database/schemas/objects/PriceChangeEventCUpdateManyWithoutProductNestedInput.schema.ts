...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCUpdateManyWithoutProductNestedInput>;
export const PriceChangeEventCUpdateManyWithoutProductNestedInputObjectSchema: SchemaType = z.object({
