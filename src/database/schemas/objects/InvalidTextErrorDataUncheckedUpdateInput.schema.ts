...
type SchemaType = z.ZodType<Prisma.InvalidTextErrorDataUncheckedUpdateInput>;
export const InvalidTextErrorDataUncheckedUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
