...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutProductNotificationConfigsInput>;
export const UserUpdateWithoutProductNotificationConfigsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
