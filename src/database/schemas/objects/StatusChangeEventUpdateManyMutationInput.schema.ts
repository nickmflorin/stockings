...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUpdateManyMutationInput>;
export const StatusChangeEventUpdateManyMutationInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
