...
type SchemaType = z.ZodType<Prisma.ProductRecordUncheckedUpdateWithoutErrorsInput>;
export const ProductRecordUncheckedUpdateWithoutErrorsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
