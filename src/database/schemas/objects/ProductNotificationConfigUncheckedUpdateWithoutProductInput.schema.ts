...
type SchemaType = z.ZodType<Prisma.ProductNotificationConfigUncheckedUpdateWithoutProductInput>;
export const ProductNotificationConfigUncheckedUpdateWithoutProductInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
