...
type SchemaType = z.ZodType<Prisma.PriceChangeEventConfigUpdateWithoutCreatedByInput>;
export const PriceChangeEventConfigUpdateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
