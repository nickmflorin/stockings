...
type SchemaType = z.ZodType<Prisma.MissingElementErrorDataUpdateManyMutationInput>;
export const MissingElementErrorDataUpdateManyMutationInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
