...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutCreatedProductsInput>;
export const UserUpdateWithoutCreatedProductsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
