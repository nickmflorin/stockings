...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCCreateNestedManyWithoutUpdatedByInput>;
export const PriceChangeEventCCreateNestedManyWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
