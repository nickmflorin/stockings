...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutUpdatedNotificationEventConfigsInput>;
export const UserUpdateWithoutUpdatedNotificationEventConfigsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
