...
type SchemaType = z.ZodType<Prisma.UserUncheckedUpdateWithoutCreatedNotificationEventConfigsInput>;
export const UserUncheckedUpdateWithoutCreatedNotificationEventConfigsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
