...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCUncheckedUpdateManyInput>;
export const PriceChangeEventCUncheckedUpdateManyInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
