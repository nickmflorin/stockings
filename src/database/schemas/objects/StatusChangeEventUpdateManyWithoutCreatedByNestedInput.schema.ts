...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUpdateManyWithoutCreatedByNestedInput>;
export const StatusChangeEventUpdateManyWithoutCreatedByNestedInputObjectSchema: SchemaType = z.object({
