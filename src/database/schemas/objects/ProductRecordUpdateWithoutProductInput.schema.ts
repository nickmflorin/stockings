...
type SchemaType = z.ZodType<Prisma.ProductRecordUpdateWithoutProductInput>;
export const ProductRecordUpdateWithoutProductInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
