...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUpdateManyWithoutUserNestedInput>;
export const StatusChangeEventUpdateManyWithoutUserNestedInputObjectSchema: SchemaType = z.object({
