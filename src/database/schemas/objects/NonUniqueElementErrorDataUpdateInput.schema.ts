...
type SchemaType = z.ZodType<Prisma.NonUniqueElementErrorDataUpdateInput>;
export const NonUniqueElementErrorDataUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
