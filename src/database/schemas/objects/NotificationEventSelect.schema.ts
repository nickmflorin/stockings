...
type SchemaType = z.ZodType<Prisma.NotificationEventSelect>;
export const NotificationEventSelectObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => UserArgsObjectSchema)]).optional(), userId: z.boolean().optional(), contentType: z.boolean().optional()
