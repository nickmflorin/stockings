...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCWhereInput>;
export const PriceChangeEventCWhereInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => PriceChangeEventCWhereInputObjectSchema),
    ...
    z.lazy(() => PriceChangeEventCWhereInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => UuidFilterObjectSchema),
