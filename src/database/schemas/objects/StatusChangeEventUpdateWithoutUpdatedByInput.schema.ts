...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUpdateWithoutUpdatedByInput>;
export const StatusChangeEventUpdateWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
