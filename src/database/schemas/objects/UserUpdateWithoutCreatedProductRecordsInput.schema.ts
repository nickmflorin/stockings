...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutCreatedProductRecordsInput>;
export const UserUpdateWithoutCreatedProductRecordsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
