...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCUpdateManyMutationInput>;
export const PriceChangeEventCUpdateManyMutationInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
