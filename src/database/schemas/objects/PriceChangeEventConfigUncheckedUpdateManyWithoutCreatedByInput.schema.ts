...
type SchemaType = z.ZodType<Prisma.PriceChangeEventConfigUncheckedUpdateManyWithoutCreatedByInput>;
export const PriceChangeEventConfigUncheckedUpdateManyWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
