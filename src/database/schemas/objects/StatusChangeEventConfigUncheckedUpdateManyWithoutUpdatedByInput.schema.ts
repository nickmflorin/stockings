...
type SchemaType = z.ZodType<Prisma.StatusChangeEventConfigUncheckedUpdateManyWithoutUpdatedByInput>;
export const StatusChangeEventConfigUncheckedUpdateManyWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
