...
type SchemaType = z.ZodType<Prisma.ProductUncheckedUpdateWithoutNotificationEventsInput>;
export const ProductUncheckedUpdateWithoutNotificationEventsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
