...
type SchemaType = z.ZodType<Prisma.StatusChangeEventCreateWithoutUserInput>;
export const StatusChangeEventCreateWithoutUserInputObjectSchema: SchemaType = z.object({
