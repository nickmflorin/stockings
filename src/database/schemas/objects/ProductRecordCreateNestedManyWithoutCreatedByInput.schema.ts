...
type SchemaType = z.ZodType<Prisma.ProductRecordCreateNestedManyWithoutCreatedByInput>;
export const ProductRecordCreateNestedManyWithoutCreatedByInputObjectSchema: SchemaType = z.object({
