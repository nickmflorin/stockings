...
type SchemaType = z.ZodType<Prisma.ProductNotificationConfigUncheckedUpdateInput>;
export const ProductNotificationConfigUncheckedUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
