...
type SchemaType = z.ZodType<Prisma.ProductUpdateWithoutDelegate_aux_Product_notificationEvents_PriceChange_0Input>;
export const ProductUpdateWithoutDelegate_aux_Product_notificationEvents_PriceChange_0InputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => ProductSubCategorySchema).array()]).optional(), createdBy: z.lazy(() => UserUpdateOneRequiredWithoutCreatedProductsNestedInputObjectSchema).optional(), updatedBy: z.lazy(() => UserUpdateOneRequiredWithoutUpdatedProductsNestedInputObjectSchema).optional(), records: z.lazy(() => ProductRecordUpdateManyWithoutProductNestedInputObjectSchema).optional(), notificationEvents: z.lazy(() => NotificationEventUpdateManyWithoutProductNestedInputObjectSchema).optional(), delegate_aux_Product_notificationEvents_StatusChang_0: z.lazy(() => StatusChangeEventUpdateManyWithoutProductNestedInputObjectSchema).optional()
