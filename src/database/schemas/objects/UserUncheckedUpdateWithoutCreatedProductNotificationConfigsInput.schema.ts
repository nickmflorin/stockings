...
type SchemaType = z.ZodType<Prisma.UserUncheckedUpdateWithoutCreatedProductNotificationConfigsInput>;
export const UserUncheckedUpdateWithoutCreatedProductNotificationConfigsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
