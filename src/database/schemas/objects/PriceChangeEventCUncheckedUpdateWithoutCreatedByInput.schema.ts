...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCUncheckedUpdateWithoutCreatedByInput>;
export const PriceChangeEventCUncheckedUpdateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
