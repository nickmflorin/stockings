...
type SchemaType = z.ZodType<Prisma.StatusChangeEventConfigUncheckedUpdateWithoutUpdatedByInput>;
export const StatusChangeEventConfigUncheckedUpdateWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
