...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCMaxAggregateInputType>;
export const PriceChangeEventCMaxAggregateInputObjectSchema: SchemaType = z.object({
