...
type SchemaType = z.ZodType<Prisma.PriceChangeEventConfigUncheckedUpdateInput>;
export const PriceChangeEventConfigUncheckedUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
