...
type SchemaType = z.ZodType<Prisma.UserUncheckedUpdateWithoutUpdatedNotificationEventConfigsInput>;
export const UserUncheckedUpdateWithoutUpdatedNotificationEventConfigsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
