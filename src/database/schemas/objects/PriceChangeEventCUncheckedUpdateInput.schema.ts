...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCUncheckedUpdateInput>;
export const PriceChangeEventCUncheckedUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
