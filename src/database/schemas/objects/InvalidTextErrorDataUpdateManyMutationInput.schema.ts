...
type SchemaType = z.ZodType<Prisma.InvalidTextErrorDataUpdateManyMutationInput>;
export const InvalidTextErrorDataUpdateManyMutationInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
