...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUncheckedUpdateManyWithoutProductInput>;
export const StatusChangeEventUncheckedUpdateManyWithoutProductInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
