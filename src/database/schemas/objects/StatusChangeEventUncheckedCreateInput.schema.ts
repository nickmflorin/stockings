...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUncheckedCreateInput>;
export const StatusChangeEventUncheckedCreateInputObjectSchema: SchemaType = z.object({
