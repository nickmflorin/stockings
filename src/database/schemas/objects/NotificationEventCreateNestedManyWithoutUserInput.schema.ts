...
type SchemaType = z.ZodType<Prisma.NotificationEventCreateNestedManyWithoutUserInput>;
export const NotificationEventCreateNestedManyWithoutUserInputObjectSchema: SchemaType = z.object({
