...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUpdateManyWithoutProductNestedInput>;
export const StatusChangeEventUpdateManyWithoutProductNestedInputObjectSchema: SchemaType = z.object({
