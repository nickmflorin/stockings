...
type SchemaType = z.ZodType<Prisma.NonUniqueElementErrorDataUncheckedUpdateInput>;
export const NonUniqueElementErrorDataUncheckedUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
