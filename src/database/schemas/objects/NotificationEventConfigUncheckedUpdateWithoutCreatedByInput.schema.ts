...
type SchemaType = z.ZodType<Prisma.NotificationEventConfigUncheckedUpdateWithoutCreatedByInput>;
export const NotificationEventConfigUncheckedUpdateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
