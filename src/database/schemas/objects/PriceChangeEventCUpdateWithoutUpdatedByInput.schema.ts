...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCUpdateWithoutUpdatedByInput>;
export const PriceChangeEventCUpdateWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => PriceChangeEventTypeSchema).array()]).optional(), createdBy: z.lazy(() => UserUpdateOneRequiredWithoutDelegate_aux_User_createdNotificationEvents_PriceCh_0NestedInputObjectSchema).optional(), product: z.lazy(() => ProductUpdateOneRequiredWithoutDelegate_aux_Product_notificationEvents_PriceChange_0NestedInputObjectSchema).optional(), user: z.lazy(() => UserUpdateOneRequiredWithoutDelegate_aux_User_notificationEvents_PriceChangeEve_0NestedInputObjectSchema).optional()
