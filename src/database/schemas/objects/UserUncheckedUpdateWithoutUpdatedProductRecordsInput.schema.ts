...
type SchemaType = z.ZodType<Prisma.UserUncheckedUpdateWithoutUpdatedProductRecordsInput>;
export const UserUncheckedUpdateWithoutUpdatedProductRecordsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
