...
type SchemaType = z.ZodType<Prisma.StatusChangeEventConfigUncheckedUpdateWithoutProductNotificationConfigInput>;
export const StatusChangeEventConfigUncheckedUpdateWithoutProductNotificationConfigInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
