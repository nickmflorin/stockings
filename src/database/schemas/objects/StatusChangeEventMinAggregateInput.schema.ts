...
type SchemaType = z.ZodType<Prisma.StatusChangeEventMinAggregateInputType>;
export const StatusChangeEventMinAggregateInputObjectSchema: SchemaType = z.object({
