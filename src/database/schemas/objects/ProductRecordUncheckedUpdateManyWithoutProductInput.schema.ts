...
type SchemaType = z.ZodType<Prisma.ProductRecordUncheckedUpdateManyWithoutProductInput>;
export const ProductRecordUncheckedUpdateManyWithoutProductInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
