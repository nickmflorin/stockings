...
type SchemaType = z.ZodType<Prisma.PriceChangeEventConfigUpdateManyMutationInput>;
export const PriceChangeEventConfigUpdateManyMutationInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
