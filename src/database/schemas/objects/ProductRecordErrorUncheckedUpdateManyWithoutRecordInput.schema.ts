...
type SchemaType = z.ZodType<Prisma.ProductRecordErrorUncheckedUpdateManyWithoutRecordInput>;
export const ProductRecordErrorUncheckedUpdateManyWithoutRecordInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
