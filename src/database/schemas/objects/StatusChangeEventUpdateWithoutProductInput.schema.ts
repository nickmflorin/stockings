...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUpdateWithoutProductInput>;
export const StatusChangeEventUpdateWithoutProductInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
