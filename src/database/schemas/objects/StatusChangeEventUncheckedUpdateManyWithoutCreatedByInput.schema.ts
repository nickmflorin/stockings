...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUncheckedUpdateManyWithoutCreatedByInput>;
export const StatusChangeEventUncheckedUpdateManyWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
