...
type SchemaType = z.ZodType<Prisma.InvalidAttributeErrorDataWhereInput>;
export const InvalidAttributeErrorDataWhereInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => InvalidAttributeErrorDataWhereInputObjectSchema),
    ...
    z.lazy(() => InvalidAttributeErrorDataWhereInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => UuidFilterObjectSchema),
