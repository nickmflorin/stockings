...
type SchemaType = z.ZodType<Prisma.StatusChangeEventUncheckedUpdateManyWithoutUserInput>;
export const StatusChangeEventUncheckedUpdateManyWithoutUserInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
