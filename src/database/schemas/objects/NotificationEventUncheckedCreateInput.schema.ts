...
type SchemaType = z.ZodType<Prisma.NotificationEventUncheckedCreateInput>;
export const NotificationEventUncheckedCreateInputObjectSchema: SchemaType = z.object({
