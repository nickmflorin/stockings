...
type SchemaType = z.ZodType<Prisma.ProductRecordCreateManyCreatedByInput>;
export const ProductRecordCreateManyCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.string().optional(), createdAt: z.union([z.date().optional(), z.string().datetime().optional()]), updatedAt: z.union([z.date().optional(), z.string().datetime().optional()]), updatedById: z.string(), timestamp: z.union([z.date().optional(), z.string().datetime().optional()]), productId: z.string(), price: z.union([z.number(),
