...
type SchemaType = z.ZodType<Prisma.StatusChangeEventConfigUncheckedUpdateManyWithoutCreatedByInput>;
export const StatusChangeEventConfigUncheckedUpdateManyWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
