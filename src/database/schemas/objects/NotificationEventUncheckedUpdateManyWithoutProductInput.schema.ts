...
type SchemaType = z.ZodType<Prisma.NotificationEventUncheckedUpdateManyWithoutProductInput>;
export const NotificationEventUncheckedUpdateManyWithoutProductInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
