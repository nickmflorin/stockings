...
import { UserUpdateOneRequiredWithoutDelegate_aux_User_createdNotificationEvents_PriceCh_0NestedInputObjectSchema } from './UserUpdateOneRequiredWithoutDelegate_aux_User_createdNotificationEvents_PriceCh_0NestedInput.schema';
...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCUpdateWithoutProductInput>;
export const PriceChangeEventCUpdateWithoutProductInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => PriceChangeEventTypeSchema).array()]).optional(), createdBy: z.lazy(() => UserUpdateOneRequiredWithoutDelegate_aux_User_createdNotificationEvents_PriceCh_0NestedInputObjectSchema).optional(), updatedBy: z.lazy(() => UserUpdateOneRequiredWithoutDelegate_aux_User_updatedNotificationEvents_PriceCh_0NestedInputObjectSchema).optional(), user: z.lazy(() => UserUpdateOneRequiredWithoutDelegate_aux_User_notificationEvents_PriceChangeEve_0NestedInputObjectSchema).optional()
