...
type SchemaType = z.ZodType<Prisma.NotificationEventConfigUpdateWithoutCreatedByInput>;
export const NotificationEventConfigUpdateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.lazy(() => EnumNotificationEventConfigContentTypeFieldUpdateOperationsInputObjectSchema)]).optional(), updatedBy: z.lazy(() => UserUpdateOneRequiredWithoutUpdatedNotificationEventConfigsNestedInputObjectSchema).optional(), productNotificationConfig: z.lazy(() => ProductNotificationConfigUpdateOneRequiredWithoutEventConfigsNestedInputObjectSchema).optional()
