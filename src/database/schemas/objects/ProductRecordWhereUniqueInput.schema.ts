...
type SchemaType = z.ZodType<Prisma.ProductRecordWhereUniqueInput>;
export const ProductRecordWhereUniqueInputObjectSchema: SchemaType = z.object({
    id: z.string().optional(), AND: z.union([z.lazy(() => ProductRecordWhereInputObjectSchema),
    ...
    z.lazy(() => ProductRecordWhereInputObjectSchema).array()]).optional(), createdAt: z.union([z.lazy(() => DateTimeFilterObjectSchema),
