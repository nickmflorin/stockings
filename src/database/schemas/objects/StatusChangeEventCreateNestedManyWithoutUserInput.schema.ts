...
type SchemaType = z.ZodType<Prisma.StatusChangeEventCreateNestedManyWithoutUserInput>;
export const StatusChangeEventCreateNestedManyWithoutUserInputObjectSchema: SchemaType = z.object({
