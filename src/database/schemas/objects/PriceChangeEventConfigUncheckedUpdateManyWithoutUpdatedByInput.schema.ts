...
type SchemaType = z.ZodType<Prisma.PriceChangeEventConfigUncheckedUpdateManyWithoutUpdatedByInput>;
export const PriceChangeEventConfigUncheckedUpdateManyWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
