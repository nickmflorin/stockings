...
type SchemaType = z.ZodType<Prisma.UserUncheckedUpdateWithoutNotificationEventsInput>;
export const UserUncheckedUpdateWithoutNotificationEventsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
