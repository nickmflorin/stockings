...
type SchemaType = z.ZodType<Prisma.StatusChangeEventWhereInput>;
export const StatusChangeEventWhereInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => StatusChangeEventWhereInputObjectSchema),
    ...
    z.lazy(() => StatusChangeEventWhereInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => UuidFilterObjectSchema),
