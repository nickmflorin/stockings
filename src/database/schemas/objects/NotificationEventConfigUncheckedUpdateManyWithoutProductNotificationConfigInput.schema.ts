...
type SchemaType = z.ZodType<Prisma.NotificationEventConfigUncheckedUpdateManyWithoutProductNotificationConfigInput>;
export const NotificationEventConfigUncheckedUpdateManyWithoutProductNotificationConfigInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
