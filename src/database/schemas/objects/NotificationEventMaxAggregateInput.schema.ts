...
type SchemaType = z.ZodType<Prisma.NotificationEventMaxAggregateInputType>;
export const NotificationEventMaxAggregateInputObjectSchema: SchemaType = z.object({
