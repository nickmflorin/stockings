...
type SchemaType = z.ZodType<Prisma.ProductUpsertWithoutDelegate_aux_Product_notificationEvents_PriceChange_0Input>;
export const ProductUpsertWithoutDelegate_aux_Product_notificationEvents_PriceChange_0InputObjectSchema: SchemaType = z.object({
    update: z.union([z.lazy(() => ProductUpdateWithoutDelegate_aux_Product_notificationEvents_PriceChange_0InputObjectSchema),
    z.lazy(() => ProductUncheckedUpdateWithoutDelegate_aux_Product_notificationEvents_PriceChange_0InputObjectSchema)]), create: z.union([z.lazy(() => ProductCreateWithoutDelegate_aux_Product_notificationEvents_PriceChange_0InputObjectSchema),
    z.lazy(() => ProductUncheckedCreateWithoutDelegate_aux_Product_notificationEvents_PriceChange_0InputObjectSchema)]), where: z.lazy(() => ProductWhereInputObjectSchema).optional()
