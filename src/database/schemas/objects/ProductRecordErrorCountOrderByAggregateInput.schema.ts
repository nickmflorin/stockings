...
type SchemaType = z.ZodType<Prisma.ProductRecordErrorCountOrderByAggregateInput>;
export const ProductRecordErrorCountOrderByAggregateInputObjectSchema: SchemaType = z.object({
