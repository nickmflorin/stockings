...
type SchemaType = z.ZodType<Prisma.ProductNotificationConfigUncheckedUpdateWithoutCreatedByInput>;
export const ProductNotificationConfigUncheckedUpdateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
