...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCUncheckedUpdateWithoutProductInput>;
export const PriceChangeEventCUncheckedUpdateWithoutProductInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
