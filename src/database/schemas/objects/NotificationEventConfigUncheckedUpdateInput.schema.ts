...
type SchemaType = z.ZodType<Prisma.NotificationEventConfigUncheckedUpdateInput>;
export const NotificationEventConfigUncheckedUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
