...
type SchemaType = z.ZodType<Prisma.NotificationEventUncheckedCreateNestedManyWithoutProductInput>;
export const NotificationEventUncheckedCreateNestedManyWithoutProductInputObjectSchema: SchemaType = z.object({
