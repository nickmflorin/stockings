...
export const ProductUpdateWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    ...
    z.lazy(() => ProductSubCategorySchema).array()]).optional(), updatedBy: z.lazy(() => UserUpdateOneRequiredWithoutUpdatedProductsNestedInputObjectSchema).optional(), records: z.lazy(() => ProductRecordUpdateManyWithoutProductNestedInputObjectSchema).optional(), notificationEvents: z.lazy(() => NotificationEventUpdateManyWithoutProductNestedInputObjectSchema).optional(), delegate_aux_Product_notificationEvents_PriceChange_0: z.lazy(() => PriceChangeEventCUpdateManyWithoutProductNestedInputObjectSchema).optional(), delegate_aux_Product_notificationEvents_StatusChang_0: z.lazy(() => StatusChangeEventUpdateManyWithoutProductNestedInputObjectSchema).optional()
