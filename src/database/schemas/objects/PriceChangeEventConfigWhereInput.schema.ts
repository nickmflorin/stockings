...
type SchemaType = z.ZodType<Prisma.PriceChangeEventConfigWhereInput>;
export const PriceChangeEventConfigWhereInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => PriceChangeEventConfigWhereInputObjectSchema),
    ...
    z.lazy(() => PriceChangeEventConfigWhereInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => UuidFilterObjectSchema),
