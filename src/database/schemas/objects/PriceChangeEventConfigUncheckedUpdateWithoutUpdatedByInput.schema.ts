...
type SchemaType = z.ZodType<Prisma.PriceChangeEventConfigUncheckedUpdateWithoutUpdatedByInput>;
export const PriceChangeEventConfigUncheckedUpdateWithoutUpdatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
