...
type SchemaType = z.ZodType<Prisma.MissingAttributeErrorDataUncheckedUpdateInput>;
export const MissingAttributeErrorDataUncheckedUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
