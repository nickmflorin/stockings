...
type SchemaType = z.ZodType<Prisma.PriceChangeEventCUpdateWithoutUserInput>;
export const PriceChangeEventCUpdateWithoutUserInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
