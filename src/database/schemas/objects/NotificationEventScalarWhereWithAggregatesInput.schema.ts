...
type SchemaType = z.ZodType<Prisma.NotificationEventScalarWhereWithAggregatesInput>;
export const NotificationEventScalarWhereWithAggregatesInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => NotificationEventScalarWhereWithAggregatesInputObjectSchema),
    z.lazy(() => NotificationEventScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), OR: z.lazy(() => NotificationEventScalarWhereWithAggregatesInputObjectSchema).array().optional(), NOT: z.union([z.lazy(() => NotificationEventScalarWhereWithAggregatesInputObjectSchema),
    z.lazy(() => NotificationEventScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => UuidWithAggregatesFilterObjectSchema),
