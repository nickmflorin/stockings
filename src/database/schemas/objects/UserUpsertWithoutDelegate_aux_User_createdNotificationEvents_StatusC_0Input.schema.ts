...
type SchemaType = z.ZodType<Prisma.UserUpsertWithoutDelegate_aux_User_createdNotificationEvents_StatusC_0Input>;
export const UserUpsertWithoutDelegate_aux_User_createdNotificationEvents_StatusC_0InputObjectSchema: SchemaType = z.object({
    update: z.union([z.lazy(() => UserUpdateWithoutDelegate_aux_User_createdNotificationEvents_StatusC_0InputObjectSchema),
    z.lazy(() => UserUncheckedUpdateWithoutDelegate_aux_User_createdNotificationEvents_StatusC_0InputObjectSchema)]), create: z.union([z.lazy(() => UserCreateWithoutDelegate_aux_User_createdNotificationEvents_StatusC_0InputObjectSchema),
    z.lazy(() => UserUncheckedCreateWithoutDelegate_aux_User_createdNotificationEvents_StatusC_0InputObjectSchema)]), where: z.lazy(() => UserWhereInputObjectSchema).optional()
