...
type SchemaType = z.ZodType<Prisma.UserUncheckedUpdateWithoutCreatedNotificationEventsInput>;
export const UserUncheckedUpdateWithoutCreatedNotificationEventsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
