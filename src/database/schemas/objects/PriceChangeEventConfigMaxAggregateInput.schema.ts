...
type SchemaType = z.ZodType<Prisma.PriceChangeEventConfigMaxAggregateInputType>;
export const PriceChangeEventConfigMaxAggregateInputObjectSchema: SchemaType = z.object({
