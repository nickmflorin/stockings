...
type SchemaType = z.ZodType<Prisma.NotificationEventUncheckedUpdateManyWithoutCreatedByInput>;
export const NotificationEventUncheckedUpdateManyWithoutCreatedByInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
