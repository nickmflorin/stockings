...
import { ProductUpsertWithoutDelegate_aux_Product_notificationEvents_StatusChang_0InputObjectSchema } from './ProductUpsertWithoutDelegate_aux_Product_notificationEvents_StatusChang_0Input.schema';
import { ProductWhereUniqueInputObjectSchema } from './ProductWhereUniqueInput.schema';
import { ProductUpdateToOneWithWhereWithoutDelegate_aux_Product_notificationEvents_StatusChang_0InputObjectSchema } from './ProductUpdateToOneWithWhereWithoutDelegate_aux_Product_notificationEvents_StatusChang_0Input.schema';
...
type SchemaType = z.ZodType<Prisma.ProductUpdateOneRequiredWithoutDelegate_aux_Product_notificationEvents_StatusChang_0NestedInput>;
export const ProductUpdateOneRequiredWithoutDelegate_aux_Product_notificationEvents_StatusChang_0NestedInputObjectSchema: SchemaType = z.object({
    create: z.union([z.lazy(() => ProductCreateWithoutDelegate_aux_Product_notificationEvents_StatusChang_0InputObjectSchema),
    z.lazy(() => ProductUncheckedCreateWithoutDelegate_aux_Product_notificationEvents_StatusChang_0InputObjectSchema)]).optional(), connectOrCreate: z.lazy(() => ProductCreateOrConnectWithoutDelegate_aux_Product_notificationEvents_StatusChang_0InputObjectSchema).optional(), upsert: z.lazy(() => ProductUpsertWithoutDelegate_aux_Product_notificationEvents_StatusChang_0InputObjectSchema).optional(), connect: z.lazy(() => ProductWhereUniqueInputObjectSchema).optional(), update: z.union([z.lazy(() => ProductUpdateToOneWithWhereWithoutDelegate_aux_Product_notificationEvents_StatusChang_0InputObjectSchema),
    z.lazy(() => ProductUpdateWithoutDelegate_aux_Product_notificationEvents_StatusChang_0InputObjectSchema),
    z.lazy(() => ProductUncheckedUpdateWithoutDelegate_aux_Product_notificationEvents_StatusChang_0InputObjectSchema)]).optional()
