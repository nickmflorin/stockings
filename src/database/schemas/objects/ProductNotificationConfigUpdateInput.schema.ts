...
type SchemaType = z.ZodType<Prisma.ProductNotificationConfigUpdateInput>;
export const ProductNotificationConfigUpdateInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
