...
type SchemaType = z.ZodType<Prisma.UserUpdateWithoutCreatedNotificationEventsInput>;
export const UserUpdateWithoutCreatedNotificationEventsInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
